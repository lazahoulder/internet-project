 ...
 */
final class Version20230521174736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_team (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, team_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, amount_value DOUBLE PRECISION DEFAULT NULL, status VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, expected_end_date DATE DEFAULT NULL, selling_value DOUBLE PRECISION DEFAULT NULL, INDEX IDX_66FAF62C99E6F5DF (player_id), INDEX IDX_66FAF62C296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
